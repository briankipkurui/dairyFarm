...
const AddFeedingFormulasDrawer: React.FC<CattleDrawerProps> = ({
    ...
    const [livestockTypeToDisplay, setLivestockTypeToDisplay] = useState([])
    const [feedingTypesToDisplay, setFeedingTypesToDisplay] = useState([])
    const [feedTypeSearchTerm, setFeedTypeSearchTerm] = useState('')
    const [searchTermForLivestockType, setSearchTermForLivestockType] = useState('')
    const [livestockOptions, setLivestockOptions] = useState([])
    const [feedingTypesOptions, setFeedingTypesOptions] = useState([])
    const [form] = Form.useForm();


    const fetchLivestockType = () =>
        getLivestock()
            .then(res => res.json())
            .then(data => {
...
export default AddFeedingFormulasDrawer;