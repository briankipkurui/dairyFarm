...
//                .antMatchers( "/**")
                ...
                .permitAll()
                .antMatchers("/api/v1/births/users/**")
                .permitAll()
                .antMatchers("/api/v1/breeds/**")
                .permitAll()
                .antMatchers("/api/v1/breeds/users/**")
                .permitAll()
                .antMatchers("/api/v1/cattle/**")
                .permitAll()
                .antMatchers("/api/v1/cattle/users/**")
                .permitAll()
                .antMatchers("/api/v1/livestock/**")
                .permitAll()
                .antMatchers("/api/v1/livestock/users/**")
                .permitAll()
                .antMatchers("/api/v1/production/**")
                .permitAll()
                .antMatchers("/api/v1/production/users/**")
                .permitAll()
