...
@Component
public class CattleSpecifications {

    public static Specification<Cattle> applyFilter(String field, String condition, Object value) {
        return (root, query, criteriaBuilder) -> {
            try {
                ...
                if (trimmedField.contains(".")) {
                    ...
                    fieldInEntity = Cattle.class.getDeclaredField(entityField);
                } else {
                    fieldInEntity = Cattle.class.getDeclaredField(trimmedField);
                }
